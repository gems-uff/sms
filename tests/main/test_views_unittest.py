...
class TestInventoryViews(unittest.TestCase):
    ...
    def test_purchase_same_product_two_catalogs_same_lot(self):
        spec1 = models.Specification(
            catalog_number='cat1', manufacturer='man1', units=1)
        db.session.add(spec1)
        spec2 = models.Specification(
            catalog_number='cat2', manufacturer='man1', units=10)
        db.session.add(spec2)
        product1 = models.Product(name='Product1')
        product1.specifications.append(spec1)
        ...
        with self.client as client:
            ...
            res = client.get(url_for('main.purchase_product'),
                             follow_redirects=False)
            self.assertEqual(res.status_code, 200)
            self.assertEqual('/orders/add', request.path)
            ...
            res = client.post(url_for('main.purchase_product'),
            ...
            res = client.post(url_for('main.purchase_product'),
                              ...
                              follow_redirects=True)
            self.assertEqual(res.status_code, 200)
            self.assertEqual('/orders/checkout', request.path)
            ...
            client.post(url_for('main.checkout'),
                        data=order_dict,
                        follow_redirects=True)
    ...
    def test_purchase_2_diff_products(self):
        ...
        spec2 = models.Specification(
            catalog_number='cat2', manufacturer='man1', units=10)
        db.session.add(spec2)
        product1 = models.Product(name='Product1', specifications=[spec1])
        product2 = models.Product(name='Product2', specifications=[spec2])
        db.session.add(product1)
    ...
    def test_consume_product(self):
        spec1 = models.Specification(catalog_number='cat1', manufacturer='man1')
        prod1 = models.Product(name='Prod1', specifications=[spec1])
        # Add product to stock
        models.Stock.query.first().add(prod1, 'lot1', datetime.date.today(), 10)
        stock_products = models.StockProduct.query.all()
        ...
        with self.client as client:
            ...
            res = client.post(url_for('main.consume_product'),
